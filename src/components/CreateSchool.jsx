    ...
    onSubmit: async (values) => {
      ...
      try {
        const response = await axios.post(
          "https://attendipen-d65abecaffe3.herokuapp.com/schools",
          values,
          {
            headers: {
            ...
            <div>
              ...
              <nav className="naval">
                <ul>
                  ...
                  <div className="board">
                    <img src="https://res.cloudinary.com/dgxvuw8wd/image/upload/v1736281723/teacher_mmxcpi.svg" alt="Teachers" />
