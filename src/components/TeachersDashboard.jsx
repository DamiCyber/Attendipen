            ...
            <div>
              ...
              <nav className="naval">
                <ul>
                  ...
                  <div className="board">
                    <img src="https://res.cloudinary.com/dgxvuw8wd/image/upload/v1736281723/home-2_wwzqrg.png" alt="" />
                    <Link to="/Mark" className="link" >Attendance</Link>
                  </div>
                  <div className="board">
                    <img src="https://res.cloudinary.com/dgxvuw8wd/image/upload/v1736281723/home-2_wwzqrg.png" alt="" />
                  ...
                  <div className="board">
                    ...
                    <Link to="/accept/:inviteId" className="link" >Accept invite</Link>
                  </div>
                </ul>
              </nav>
            </div>
        ...
        <nav className="subdash">
          ...
          <div className="controls">
            <div className="notify">
              <img src="https://res.cloudinary.com/dgxvuw8wd/image/upload/v1736281722/bell_muudfk.svg" alt="notification" />
            </div>
            ...
            <div>
              <DropdownMenu>
                <DropdownMenuTrigger className="user-pics">
                  <img 
